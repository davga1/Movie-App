...
searchMovie(String query, String language, int page, String request) async {
  final response = await http.get(
      Uri.parse(
          'https://api.themoviedb.org/3/search/movie?query=$query&language=$language&page=$page'),
      headers: {
        'Authorization':
